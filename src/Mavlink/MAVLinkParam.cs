...
namespace System.MAVLink
{
    ...
    public class MAVLinkParam
    {
        ...
        /// </summary>
        public MAVLink.MAV_PARAM_TYPE Type { get; set; }

        private MAVLink.MAV_PARAM_TYPE _typeap = 0;
        public MAVLink.MAV_PARAM_TYPE TypeAP
        {
            get
            {
                if (_typeap != 0)
        ...
        public MAVLinkParam(string name, double value, MAVLink.MAV_PARAM_TYPE type)
        {
            Name = name;
            Type = type;
            Value = value;
        ...
        public MAVLinkParam(string name, byte[] inputwire, MAVLink.MAV_PARAM_TYPE type, MAVLink.MAV_PARAM_TYPE typeap)
        {
            Name = name;
            Type = type;
            TypeAP = typeap;
